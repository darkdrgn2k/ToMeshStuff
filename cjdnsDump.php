                        ...
                        if (!isset($bl[$ip])) {
                                ...
                                if ($NewPath!="0000.0000.0000.0001") { //dont process if im processing myself
                                        ...
                                        if (!isLink($pubKey,$ip)) { //If not linked already
                                                ...
                                                if ($res2->error=="none") {
                                                        $NewPath=$res2->result;
                                                        Process ($NewPath,$ip); //Starting Point
                                                }
                                                $depth--;
...
Process ('0000.0000.0000.0001',"ksdkzmw2uryvkfg187kxmkdup8k78urqzpn29zh1nxvl6wfdbjk0.k"); //Starting Point
